    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.CharField(blank=True, choices=[('Cleaner', 'Cleaner'), ('Plumber', 'Plumber'), ('Teacher', 'Teacher')], max_length=200)),
                ('otp', models.CharField(blank=True, max_length=200)),
